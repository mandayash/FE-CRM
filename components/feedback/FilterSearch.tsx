...
import { Search, Filter, Table, Menu, Check } from "lucide-react";
...
const FilterSearch = ({
  ...
  const handleTabChange = (tab: string) => {
    ...
    if (tab === "Selesai") {
      apiFilter = "solved";
      console.log("Selected: Selesai -> API filter: solved");
    } else if (tab === "Belum") {
      apiFilter = "pending";
      console.log("Selected: Belum -> API filter: pending");
    } else {
      apiFilter = "all";
      console.log("Selected: Semua -> API filter: all");
    }
    ...
    <div className="flex flex-col sm:flex-row justify-between gap-4 sm:items-center">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5">
        ...
        <div className="relative flex-grow sm:flex-grow-0">
          <input
            type="text"
            placeholder="Search by ID, user, station, status, etc..."
            ...
            {isColumnMenuOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border py-1 z-10">
                ...
                <div className="column-toggle-menu">
                  ...
                  <div
                    className="flex items-center justify-between px-4 py-2 text-xs hover:bg-gray-50 cursor-pointer"
                    onClick={() => toggleColumn("documentation")}
                  >
